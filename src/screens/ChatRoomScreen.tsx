...
import {
  ArrowLeft, Send, Smile, Paperclip, Mic, Phone, Video, MoreVertical, Image as ImageIcon, Loader2,
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col">
      ...
      <footer className="fixed bottom-0 left-0 right-0 bg-slate-900/80 backdrop-blur-xl border-t border-white/5 p-3 flex items-center gap-2 z-40">
        ...
        <button onClick={() => fileInputRef.current?.click()} className="p-2 text-slate-400">
        ...
        {input.trim() ? (
          ...
          <button className="w-10 h-10 bg-white/5 text-slate-400 rounded-2xl flex items-center justify-center">
